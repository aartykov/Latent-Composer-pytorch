...
class CUDACallback(Callback):
    ...
    # A helper function to log histograms
    def custom_histogram_logger(self, pl_module):
        for name, params in pl_module.named_parameters():
            name_split = name.split(".")
            if name_split[0] == "cond_stage_model" or name_split[1] == "diffusion_model":
    ...
    def on_train_epoch_end(self, trainer, pl_module, outputs):
        ...
        try:
            ...
            # logging histograms
            self.custom_histogram_logger(pl_module)
...
if __name__ == "__main__":
    ...
    if opt.resume:
        ...
        logdir = os.path.join(opt.logdir, opt.job_name)
    ...
    try:
        ...
        if not opt.finetune_from == "":
            ...
            old_state = torch.load(opt.finetune_from, map_location=model.device)

...
class UnCLIPTextProjModel(ModelMixin, ConfigMixin):
    ...
    def forward(self, *, image_embeddings, color_embeddings, text_encoder_outputs, do_classifier_free_guidance):
        ...
        clip_extra_context_tokens_color = self.clip_extra_context_tokens_proj(color_embeddings) # (B, 2048)

...
class CustomDatasetBase(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        prompt = "Hello World!" #self.txt_labels[idx]
        # Tokenize the prompt
        prompt_tokenized = self.tokenizer(prompt, truncation=True, max_length=self.text_max_length, return_length=True,
        ...
        # Resize
        image = image.resize((self.height, self.width), resample=self.interpolation)

...
class ImageEmbedder(nn.Module):
    def __init__(self, cond_img_channels, model_channels):
        super().__init__()
    ...
    def forward(self, cond_image):
        ...
        """
        out = self.silu(self.l1(cond_image))
        out = self.silu(self.l2(out))
        out = self.silu(self.l3(out))
        out = self.silu(self.l4(out))
        out = self.silu(self.l5(out))
        out = self.silu(self.l6(out))
        out = self.l7(out)
